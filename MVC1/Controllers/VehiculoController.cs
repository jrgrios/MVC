...
namespace MVC1.Controllers
{
    public class VehiculoController : Controller
    {
        ...
        public ActionResult Listado()
        {
            ...
            ViewBag.tipoExtra = db.Extras.ToList();
            var vehiculos = db.Vehiculos.Include(a => a.Serie).Include(v => v.VehiculoExtras);
        ...
        public ActionResult Edit(int id)
        {
            ...
            vehiculo.ExtrasSeleccionados = db.VehiculosExtras.Where(ve => ve.vehiculoID == id).Select(ve => ve.extraID).ToList();
